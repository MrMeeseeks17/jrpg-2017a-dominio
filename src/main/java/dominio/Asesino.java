...
public class Asesino extends Casta {
	/**
	 * Constructor.
	 * @param probCrit Contiene el porcentaje de
	 * probabilidad de hacer un daño crítico
	 * @param evasion Contiene el porcentaje de probabilidad de evitar daño
	 * @param dañoCrit Contiene el porcentaje de aumento de
	 * ataque al hacer un daño crítico
	 */

	public Asesino(final double probCrit,
	...
	@Override
	/**
	 * Primera habilidad de la Casta "Golpe Critico": En caso de que el
	...
	public boolean habilidad2(final Personaje caster,
		...
		if (caster.getEnergia() > 10) {
			...
			if (this.getProbabilidadEvitarDaño() + 0.15 < 0.5) {
				this.setProbabilidadEvitarDaño(
						this.getProbabilidadEvitarDaño()
						+ 0.15);
			} else {
