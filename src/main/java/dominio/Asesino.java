...
@Override
/**Primera habilidad de la Casta "Golpe Crítico": En caso de que el
...
if (atacado.serAtacado((int) (caster.ataque * caster.getCasta()
.getDañoCritico())) > 0) {
return true;
}
}
 ...
 * invocador poseea energía, la disminuye en 10 (el costo de realizar la
 * habilidad) y aumenta en 15% la probabilidad de evitar daño siendo el
 * maximo total 50%.*/
