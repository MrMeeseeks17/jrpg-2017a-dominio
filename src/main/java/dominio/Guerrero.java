...
String[] aux = {"Ataque Doble", "Aumentar Defensa", "Ignorar Defensa"};
...
@Override
/**Tercera habilidad de la Casta "Ignorar Defensa": En caso de que el atacante
 * poseea energía, la disminuye en 10 (el costo de realizar la
 * habilidad) y setea momenteneamente la defensa del objetivo a cero
 * previo al ataque, posteriormente la vuelve a su valor original*/
public boolean habilidad3(final Personaje caster, final Peleable atacado) {
if (caster.getEnergia() > 10) {
caster.setEnergia(caster.getEnergia() - 10);
atacado.serAtacadoPorGerreroh3(caster.getAtaque());
return true;
}
return false;
}
