...
/**Entidad:
 * Clase abstracta que hereda a Personaje y NonPlayableCharacter.
...
/**Constructor.
 * Asigna valores a la Entidad.
 * Recibe valor de los atributos nombre, salud, fuerza y nivel.
 * @param nomb Nombre de la entidad
 * @param sal Puntos de salud de la entidad
 * @param fuer Puntos de fuerza de la entidad
 * @param lvl Nivel de la entidad */
Entidad(final String nomb, final int sal,
final int fuer, final int lvl) {
this.nombre = nomb;
this.salud = sal;
this.fuerza = fuer;
this.nivel = lvl;
...
/**Constructor.
 * Asigna valores a la Entidad.
 * Recibe valor de los atributos nombre, nivel y fuerza.
 * @param nomb Nombre de la entidad
 * @param lvl Nivel de la entidad
 * @param fuer Puntos de fuerza de la entidad */
...
public void setNivel(final int lvl) {
this.nivel = lvl;
}
/**Getter de Nombre.
...
public void setFuerza(final int fuer) {
this.fuerza = fuer;
}
/**Getter de Salud.
...
public void setSalud(final int sal) {
this.salud = sal;
}
/**Getter de Defensa.
...
abstract public int serAtacado(int ataqueRecibido);
abstract public int atacar(Peleable atacado);
}
