...
public abstract class Casta implements Serializable {
	/**
	 * Contiene el porcentaje de probabilidad de hacer un daño crítico.
	 */
	private double probabilidadGolpeCritico;
	/**
	 * Contiene el porcentaje de probabilidad de evitar daño.
	 */
	private double probabilidadEvitarDaño;
	/**
	 * Contiene el porcentaje de aumento de ataque al hacer un daño crítico.
	 */
	 ...
	 * @return Devuelve verdadero en caso de haber realizado
	 * correctamente la habilidad, falso en caso contrario
	 */
	 ...
	 * @return array de String en en que se encuentran las habilidades
	 *         mencionadas
	 */
	 ...
	 * @param probabGolpeCritico Contiene el porcentaje de probabilidad a
	 *        asignar
	 */
	public void setProbabilidadGolpeCritico(
			final double probabGolpeCritico) {
	 ...
	 * @param probabEvitarDaño Contine el porcentaje de
	...
	/**
	 * Devuelve el porcentaje de aumento en el ataque al hacer
	 * un daño crítico.
	...
	/**
	 * Define el porcentaje de aumento en el ataque al hacer
	 * un daño crítico.
	 * @param dañoCrit Contiene el porcentaje de aumento ofensivo
	 */
	public void setDañoCritico(final double dañoCrit) {
		this.dañoCritico = dañoCrit;
	}

	/**
	 * Especifica la implmentación del método bonusDestreza.
	 * @return Int con el bonus de Destreza
	 */
	protected abstract int bonusDestreza();

	/**
	 * Especifica la implmentación del método bonusFuerza.
	 * @return Int con el bonus de Fuerza
	 */
	protected abstract int bonusFuerza();

	/**
	 * Especifica la implmentación del método bonusInteligencia.
	 * @return Int con el bonus de Inteligencia
	 */
	protected abstract int bonusInteligencia();
}
