...
/**Contiene el nombre de la Alianza.*/
	...
	public LinkedList<Personaje> getAliados() {
		return new LinkedList<>(aliados);
	}

	/**Define los miembros de la alianza.
	 * @param alia2
	 * Es la lista de elementos Personaje que conforman la alianza*/
	 ...
	 * @param pj Es el objeto Personaje que se desea sacar del listado de
	 *        miembros
	 */
	 ...
	 * @param pj Es el objeto Personaje que se desea
